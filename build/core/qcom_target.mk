...
ifeq ($(BOARD_USES_QCOM_HARDWARE),true)
    ...
    else ifneq ($(filter msm8909 msm8916,$(TARGET_BOARD_PLATFORM)),)
        QCOM_AUDIO_VARIANT := audio-caf/msm8916
        QCOM_DISPLAY_VARIANT := display-caf/msm8916
        QCOM_MEDIA_VARIANT := media-caf/msm8916
    else ifneq ($(filter msm8992 msm8994,$(TARGET_BOARD_PLATFORM)),)
        QCOM_AUDIO_VARIANT := audio-caf/msm8994
        QCOM_DISPLAY_VARIANT := display-caf/msm8994
        QCOM_MEDIA_VARIANT := media-caf/msm8994
    else
